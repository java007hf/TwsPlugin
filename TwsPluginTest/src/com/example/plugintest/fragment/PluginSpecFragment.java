...
public class PluginSpecFragment extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.plugin_test_btn1) {
			...
			View view = pluginInflater.inflate(com.tws.plugin.sharelib.R.layout.share_main, null, false);
			mRoot.addView(view);
			Toast.makeText(this.getActivity(), getString(com.tws.plugin.sharelib.R.string.share_string_1),
					Toast.LENGTH_LONG).show();
		} else if (v.getId() == R.id.plugin_test_btn3) {
			View view = LayoutInflater.from(getActivity()).inflate(com.tws.plugin.sharelib.R.layout.share_main,
					null, false);
			mRoot.addView(view);
