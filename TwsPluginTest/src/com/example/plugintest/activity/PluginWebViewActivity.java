...
public class PluginWebViewActivity extends Activity implements OnClickListener {
	...
	private void testNotification() {
		...
		builder.setContentIntent(contentIndent)
				.setSmallIcon(com.tws.plugin.sharelib.R.drawable.ic_launcher)//设置状态栏里面的图标（小图标） 　　　　　　　　　　　　　　　　　　　　.setLargeIcon(BitmapFactory.decodeResource(res, R.drawable.i5))//下拉下拉列表里面的图标（大图标） 　　　　　　　.setTicker("this is bitch!") //设置状态栏的显示的信息
